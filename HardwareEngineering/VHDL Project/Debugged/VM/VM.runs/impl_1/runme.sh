...
HD_PWD='C:/Users/49152/Documents/FPGA/Submissions/DebuggedVM/stef/stefVM/stefVM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VM.tcl -notrace
